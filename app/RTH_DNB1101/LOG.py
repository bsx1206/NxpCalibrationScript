...
class sLOG():
    @staticmethod
    def DBG(s:str, end='\n') -> None:
        print("\033[0;34;40m[%s]:DBG: %s\033[0m" % (FMT_NOW_US(), s), end='\n')

    @staticmethod
    def INF(s:str, end='\n') -> None:
        print("\033[0;37;40m[%s]:INF: %s\033[0m" % (FMT_NOW_US(), s), end='\n')

    @staticmethod
    def WRN(s:str, end='\n') -> None:
        print("\033[0;33;40m[%s]:WRN: %s\033[0m" % (FMT_NOW_US(), s), end='\n')

    @staticmethod
    def ERR(s:str, end='\n') -> None:
        print("\033[0;31;40m[%s]:ERR: %s\033[0m" % (FMT_NOW_US(), s), end='\n')

    @staticmethod
    def SUC(s:str, end='\n') -> None:
        print("\033[0;32;40m[%s]:SUC: %s\033[0m" % (FMT_NOW_US(), s), end='\n')
